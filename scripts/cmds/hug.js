...
module.exports = {
  ...
  onStart: async function ({ event, message, usersData }) {
    ...
    // Prompt includes your character name "Goku Black"
    const prompt = `two people hugging each other, romantic, realistic style, character: Goku Black`;
